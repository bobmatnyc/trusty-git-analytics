...
use crate::formatters::{csv as csv_fmt, json as json_fmt, markdown as md_fmt};

/// Default output directory when [`tga_core::config::OutputConfig::directory`] is unset.
...
impl ReportPipeline {
    ...
    fn resolve_output_dir(&self) -> PathBuf {
        ...
        {
            Some(p) => tga_core::config::expand_path(p),
