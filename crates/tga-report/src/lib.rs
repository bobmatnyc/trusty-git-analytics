//! # tga-report
//!
//! Stage 3 of the `trusty-git-analytics` pipeline: read classified commits
//! from a SQLite database and generate CSV, JSON, and Markdown reports.
//!
//! ## Modules
//!
...
mod tests {
    ...
    use tga_core::config::{Config, OutputConfig, RepositoryConfig};
