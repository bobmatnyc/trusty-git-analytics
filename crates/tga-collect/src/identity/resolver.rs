...
use tga_core::config::TeamConfig;
...
impl IdentityResolver {
    ...
    /// # Errors
    ///
    /// Returns [`tga_core::TgaError::DbError`] on SQL failure.
    pub fn upsert_author(&self, db: &Database, name: &str, email: &str) -> tga_core::Result<i64> {
...
mod tests {
    use super::*;
    use std::collections::HashMap;
    use tga_core::config::{TeamConfig, TeamMember};
