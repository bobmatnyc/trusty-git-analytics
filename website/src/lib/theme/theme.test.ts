...
/**
 * Why: the theme preference is written by two independent pieces of code —
 * the pre-paint snippet inlined in `app.html` and this module — and they
 * agree only by convention. A rename on one side produces a flash of the
 * wrong palette that no build gate would catch.
 * Test: this file.
 */
